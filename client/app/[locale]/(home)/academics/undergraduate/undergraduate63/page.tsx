                    ...
                    <div className="p-1 pt-3 ">
                        <div className="p-5">
                            ...
                            <table className="w-full mb-14">
                                <thead className="text-lg text-black uppercase bg-[#F29D35]">
                                    <tr>
                                        <th scope="col" className="px-3 md:px-6 py-3 text-left" colSpan={3}>
                                            {u("title23")}
                                        </th>
                                    </tr>
                                </thead>
                            ...
                            <table className="w-full mb-14">
                                ...
                                <tbody>
                                    <tr className="bg-[#FCDCB4] text-black uppercase font-bold" id='oi'>
                                        <th
                                            scope="row"
                                            className="p-1 md:p-4 text-left border-solid border-[#EFB770] border-1 w-1/5"
                                            colSpan={3}
                                        >
                                            {u("title39")}
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="bg-[#FCDCB4] text-[#FF0000] uppercase font-bold">
                                            <td
                                                scope="row"
                                                className="p-1 md:p-4 font-medium text-left border-solid border-[#EFB770] border-1 w-1/5 "
                                                colSpan={3}
                                            >
                                                {u("title52")}
                                            </td>
