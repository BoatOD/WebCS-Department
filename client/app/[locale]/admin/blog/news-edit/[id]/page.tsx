...
const ProductDetail = ({ params: { id } }: Params) => {
  ...
  return (
    <>
      ...
      <div className={edit ? "flex flex-col md:flex-row mx-auto w-full max-w-screen-xl px-[1rem] gap-[3rem] hidden" : "flex flex-col md:flex-row mx-auto w-full max-w-screen-xl px-[1rem] gap-[3rem] justify-center"}>
