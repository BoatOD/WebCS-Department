            ...
            <Sidebar theme={SidebarCustomTheme} className="w-full">
              <Sidebar.Items className="bg-white p-0">
                <Sidebar.ItemGroup className="bg-white p-0">
                  ...
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border-1"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#analysis">การวิเคราะห์ข้อมูลอัจฉริยะ</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#obj">วัตถุประสงค์ของหลักสูตร</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#quali">คุณสมบัติของผู้สมัคร</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#process">กระบวนการรับสมัคร</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#candidacy">การสมัครและเอกสารที่ใช้</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#thc">วิธีจัดการเรียนการสอนกระบวนวิชา</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
                  <Sidebar.Item href="#">
                    <p><a href="#studyplan">แผนการศึกษา</a></p>
                  </Sidebar.Item>
                  <div className="flex flex-col space-y-1 mt-7">
                    <div className="px-8 py-0.5 bg-slate-500" className="border"></div>
                  </div>
