    ...
    <div className="flex flex-col md:flex-row  mx-auto w-full max-w-screen-xl px-[1rem]  gap-[3rem]">
        <div className="w-full md:w-2/3 order-last md:order-first ">
          ...
          <div className="p-1 pt-3 ">
            <div className="p-5">
              <h1>3. การวิเคราะห์ข้อมูลและการแสดงมโนภาพข้อมูลสำหรับผู้เรียนระดับต้นด้วย Google Data Studio</h1> 
              <br />
              <table>
              <tr>
                <th>ช่วงวันรับสมัคร :</th>
                <td class = "row_white">1 กันยายน – 20 ตุลาคม 2564</td>
              </tr>
              <tr>
                <th>ช่วงเวลาเรียน :</th>
                <td class = "row_white">1-5 พฤศจิกายน 2564 เวลา 9:00-12:00 น.</td>
              </tr>
              <tr>
                <th>ช่องทางรับการสมัคร :</th>
                <td class = "row_white">*โปรดติดตามประกาศอีกครั้ง เริ่มรับสมัคร 1 กันยายนเนื้อหาหลักสูตร</a></td>
              </tr>
              </table>
              ...
              <ul style={{ listStyleType: "disc"}}>
                <li>Introduction to Google Data Studio features</li>
                <li>Connecting to data sources</li>
                <li>Building Reports & Dashboards in Google Data Studio</li>
                <ul style={{ listStyleType: "disc"}}> {/*ต้องย่อหน้าเข้าไปอีก มันยังไม่ย่อให้*/}
                  <li>Creating charts and tables</li>
                  <li>Customizing style and formatting</li>
                  <li>Using various chart types: Area chart, Bar chart, Bullet chart, Geo map, Pie chart, Scatter plot, Scorecard, Table, Time series, etc.</li>
                </ul>
              </ul>

              <ul style={{ listStyleType: "disc"}}>
                <li>Applying filters and interactive</li>
                <li>Sharing & Collaboration</li>
                <ul style={{ listStyleType: "disc"}}> {/*ต้องย่อหน้าเข้าไปอีก มันยังไม่ย่อให้*/}
                  <li>Report sharing options</li>
