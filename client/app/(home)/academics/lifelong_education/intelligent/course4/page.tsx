    ...
    <div className="flex flex-col md:flex-row  mx-auto w-full max-w-screen-xl px-[1rem]  gap-[3rem]">
        <div className="w-full md:w-2/3 order-last md:order-first ">
          ...
          <div className="p-1 pt-3 ">
            <div className="p-5">
              <h1>4. การวิเคราะห์ข้อมูลพื้นฐานด้วยเทคนิคการเรียนรู้ของเครื่องสำหรับงานประยุกต์ด้านชีวสารสนเทศศาสตร์</h1> 
              <br />
              <table>
              <tr>
              ...
              <tr>
                ...
                <td class = "row_white">* โปรดติดตามประกาศอีกครั้ง เริ่มรับสมัคร 1 กันยายน</td>
              </tr>
              </table>
              ...
              <ul style={{ listStyleType: "disc"}}>
                <li>Preparing and working with custom data</li>
                <li>Basic exploration and visualization of single-cell datasets</li>
                <li>Building Reports & Dashboards in Google Data Studio</li>
                <li>Marker genes and cell scoring</li>
                <li>Cell classification</li>
                <li>Cell clustering and cluster characterization</li>
                <li>Performance evaluation</li>
                <li>Model parameters tunin</li>
              </ul>
